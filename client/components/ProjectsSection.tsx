...
export function ProjectsSection() {
  ...
  return (
    <section
      id="projects"
      ref={sectionRef}
      className="py-24 bg-gradient-to-br from-background to-portfolio-purple-50/10"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          >
            ...
            <p className="text-xl text-foreground/70 max-w-3xl mx-auto leading-relaxed">
              ...
              with modern technologies, AI integration, and best practices in
                ...
                >
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <Button
                      variant="outline"
                      asChild
                      className="border-white/20 hover:border-white/40 bg-white/5 hover:bg-white/10 backdrop-blur-sm"
                    >
                      <a
                        href={project.github}
                        target="_blank"
            ...
            {otherProjects.map((project, index) => (
              ...
              >
                <div className="mb-4">
                  ...
                  <h4 className="text-xl font-semibold text-foreground mb-2 group-hover:text-gradient transition-all duration-300">
                    {project.title}
                  </h4>
        ...
        {/* GitHub CTA */}
        <div
          className={`text-center mt-16 transition-all duration-1000 delay-1500 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
        >
          <Button
            asChild
            variant="outline"
