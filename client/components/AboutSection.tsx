...
export function AboutSection() {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        "End-to-end development from concept to deployment with modern development practices.",
    },
    {
      icon: Zap,
    ...
    },
    {
      ...
      description:
        "Working effectively in agile teams with strong communication and leadership skills.",
    },
    {
      icon: Award,
      title: "Best Practices",
      description:
        "Following industry standards, clean code principles, and continuous learning mindset.",
    },
  ];
  ...
  return (
    <section
      id="about"
      ref={sectionRef}
      className="py-24 bg-gradient-to-br from-background to-portfolio-navy-50/10"
    >
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <p className="text-xl text-foreground/70 max-w-3xl mx-auto leading-relaxed">
              ...
              that make a difference. With a strong foundation in modern web
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap gap-4 mt-8">
                <div className="bg-gradient-to-r from-portfolio-navy-500/10 to-portfolio-purple-500/10 rounded-lg px-4 py-2 border border-portfolio-navy-500/20">
                  <span className="text-sm font-medium text-portfolio-navy-700 dark:text-portfolio-navy-300">
                    Problem Solver
                  </span>
                </div>
                <div className="bg-gradient-to-r from-portfolio-purple-500/10 to-portfolio-cyan-500/10 rounded-lg px-4 py-2 border border-portfolio-purple-500/20">
                  <span className="text-sm font-medium text-portfolio-purple-700 dark:text-portfolio-purple-300">
                    Team Player
                  </span>
                </div>
                <div className="bg-gradient-to-r from-portfolio-cyan-500/10 to-portfolio-navy-500/10 rounded-lg px-4 py-2 border border-portfolio-cyan-500/20">
                  <span className="text-sm font-medium text-portfolio-cyan-700 dark:text-portfolio-cyan-300">
                    Continuous Learner
                  </span>
                </div>
              </div>
