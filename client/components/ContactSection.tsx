...
export function ContactSection() {
  ...
  return (
    <section id="contact" ref={sectionRef} className="py-24 bg-gradient-to-br from-portfolio-navy-50/10 to-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <h2 className="text-4xl lg:text-5xl font-bold text-gradient mb-6">Let's Work Together</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div className={`transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            <div className="space-y-8">
              ...
              {/* Availability */}
              <div className={`p-6 bg-gradient-to-r from-portfolio-navy-500/10 to-portfolio-purple-500/10 rounded-xl border border-portfolio-navy-500/20 transition-all duration-1000 delay-1200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
